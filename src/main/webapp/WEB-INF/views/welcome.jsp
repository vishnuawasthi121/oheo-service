...
<body>
	...
	<form action="/payment/charge" method="POST" name="razorpayForm" modelAttribute="paymentOrder">
		<input id="razorpay_payment_id" type="hidden" name="order_id" /> 
		<input id="order_id" type="hidden" name="order_id" path="order_id" /> 	
